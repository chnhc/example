<template>
  <div class="chat" :style="{height:mHeight}">

        <el-main  :style="{height:mHeight}">

          <el-row :gutter="20">
            <el-col :span="18" class="echarts-item">
              <div class="content-title">网站引流</div>
          ...
          <el-row :gutter="20">
            <el-col :span="18" class="echarts-item">
              <div class="content-title">网站收益</div>
          ...
          <el-row :gutter="20">
            <el-col :span="18" class="echarts-item">
              <div class="content-title">网站指标</div>
          ...
          <el-row :gutter="20">
            <el-col :span="18" class="echarts-item">
              <div class="content-title">服务器状态</div>
