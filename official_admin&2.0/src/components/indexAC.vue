  ...
  <div class="add" :style="{height:mHeight}">
    ...
    <el-form ref="form" :model="form" label-width="90px">
        ...
        <el-form-item label="优势标题">
          <el-input v-model="form.adtitle"  placeholder="输入20个字符以内" clearable></el-input>
        </el-form-item>
        <el-form-item label="优势副标题">
          <el-input v-model="form.adsubhead" placeholder="输入20个字符以内" clearable></el-input>
        </el-form-item>
    ...
    export default {
      props: {
        ...
        methods: {
           ...
           submitUpload(){
             https.fetchPost("/api/index/updateIndexAC",this.form).then((data) => {
