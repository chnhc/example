    ...
    <el-form ref="form" :model="form" label-width="100px">
      <el-form-item >
        ...
        <el-form-item label="团队标题">
          <el-input v-model="form.team_title"  placeholder="输入20个字符以内" clearable></el-input>
        </el-form-item>
        <el-form-item label="团队说明">
          <el-input v-model="form.team_desc"  placeholder="输入20个字符以内" clearable></el-input>
        </el-form-item>
          ...
          addFile(file,fileList){
           ...
           submitUpload(){
             if(this.fileList.length == 0){
               https.fetchPost("/api/aboutUS/insertTeam",this.form).then((data) => {
