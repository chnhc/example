  ...
  <div class="add" :style="{height:mHeight}">
    ...
    <el-form ref="form" :model="form" label-width="100px">
        ...
        <el-form-item label="案例标题">
          <el-input v-model="form.case_title" placeholder="输入20个字符以内" clearable></el-input>
        </el-form-item>
        <el-form-item label="案例副标题">
          <el-input v-model="form.case_subhead" placeholder="输入20个字符以内" clearable></el-input>
        </el-form-item>
        <el-form-item label="案例说明">
          <el-input type="textarea" v-model="form.case_text"></el-input>
        </el-form-item>
        ...
        <el-form-item label="更换图片">
              <el-upload
                class="upload-demo"
                ref="upload"
                action="/api/successCase/insertCase"
                :file-list="fileList"
                :headers="getHeader"
                :data=form
        ...
        methods: {
          ...
          submitUpload(){
            if(this.fileList.length == 0){
              https.fetchPost("/api/successCase/insertCase",this.form).then((data) => {
