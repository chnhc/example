  ...
  <div class="add" :style="{height:mHeight}">
    ...
    <el-form ref="form" :model="form" label-width="100px">
        ...
        <el-form-item label="服务标题">
          <el-input v-model="form.service_title"  placeholder="输入20个字符以内" clearable></el-input>
        </el-form-item>
        <el-form-item label="服务内容">
          <el-input v-model="form.service_desc"  placeholder="输入20个字符以内" clearable></el-input>
        </el-form-item>
        ...
        <el-form-item label="更换图片">
              <el-upload
                class="upload-demo"
                ref="upload"
                action="/api/business/insertService"
                :file-list="fileList"
                :data=form
                :headers="getHeader"
          ...
          addFile(file,fileList){
           ...
           submitUpload(){
             ...
             if(this.fileList.length == 0){
               https.fetchPost("/api/business/insertService",this.form).then((data) => {
