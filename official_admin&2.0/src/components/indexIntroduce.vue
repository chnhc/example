<template>
  <div class="indexIntroduce" :style="{height:mHeight}">

    <el-form ref="form" :model="form" label-width="100px">
        <el-form-item label="介绍标题">
          <el-input v-model="form.title" placeholder="输入7个字符以内" clearable></el-input>
        </el-form-item>
        <el-form-item label="介绍副标题">
          <el-input v-model="form.subhead" placeholder="输入15个字符以内" clearable></el-input>
        </el-form-item>
        ...
        <el-form-item label="更换图片">
              <el-upload
                class="upload-demo"
                ref="upload"
                action="api/index/updateIndexIntro"
                :file-list="fileList"
                :data=form
                :headers="getHeader"
          ...
          addFile(file,fileList){
           ...
           submitUpload(){
             if(this.fileList.length == 0){
               https.fetchPost("/api/index/updateIndexIntro",this.form).then((data) => {
