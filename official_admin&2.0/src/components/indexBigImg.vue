  ...
  <div class="add" :style="{height:mHeight}">
    ...
    <el-form ref="form" :model="form" label-width="120px">
        <el-form-item label="大图标题">
          <el-input v-model="form.title" placeholder="输入20个字符以内" clearable></el-input>
        </el-form-item>
        <el-form-item label="大图副标题">
          <el-input v-model="form.subhead"  placeholder="输入20个字符以内" clearable></el-input>
        </el-form-item>
        <el-form-item label="大图说明">
          <el-input v-model="form.desc"  placeholder="输入40个字符以内" clearable></el-input>
        </el-form-item>
        ...
        <el-form-item label="更换大图">
              <el-upload
                class="upload-demo"
                ref="upload"
                action="/api/index/updateIndexBigImg"
                :file-list="fileList"
                :data=form
                :headers="getHeader"
          ...
          addFile(file,fileList){
           ...
           submitUpload(){
             if(this.fileList.length == 0){
               https.fetchPost("/api/index/updateIndexBigImg",this.form).then((data) => {
